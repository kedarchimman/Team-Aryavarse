          ...
          >
            ...
            >
              ...
              <div class="hover-actions" v-if="hoveredProduct === product.id">
                <button class="quick-btn" @click="goToWomenProduct(product.id)">
                  Quick View
                </button>
              </div>
            </div>
...
const getFabricDescription = (fabric) => {
  if (fabric === 'Silk') return 'Silk smooth • Elegant • Premium feel'
  if (fabric === 'Cotton') return 'Cotton soft • Breathable • Everyday comfort'
  if (fabric === 'Linen') return 'Linen light • Airy • Summer wear'
