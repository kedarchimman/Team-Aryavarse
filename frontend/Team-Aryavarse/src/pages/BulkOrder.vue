...
<div class="form-row form-row--2">
  ...
  <div class="form-field">
    ...
    <q-input v-model="form.gst" outlined dense />
  </div>

  <div class="form-field">
    <p class="field-label">Postal Code</p>
    <q-input v-model="form.postalCode" outlined dense />
  </div>
</div>
...
<div class="form-row">
  <div class="form-field">
    ...
    <q-input v-model="form.address" type="textarea" outlined dense />
  </div>
</div>
</div>
...
<div class="form-section">
  ...
  <div class="form-row form-row--2">
    ...
    <div class="form-field">
      <p class="field-label">Quantity (Min. 20) <span class="required">*</span></p>
      <q-input
